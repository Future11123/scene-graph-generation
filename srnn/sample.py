...
def main():
    ...
    parser.add_argument(
        "--pred_length", type=int, default=10, help="Predicted length of the trajectory"
    )
    # Model to be loaded
    parser.add_argument(
    ...
    # 使用动态seq_length和pred_length
    sample_args.obs_length = saved_args.seq_length - saved_args.pred_length  # 31
    sample_args.pred_length = saved_args.pred_length
